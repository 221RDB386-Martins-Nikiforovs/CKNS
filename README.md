...
Android lietotnes pirmkoda kompilācijai, ja tiek mainīts ONNX modelis (pēc noklusējuma izmantots "400px" apakšmodelis) nepieciešams manuāli nomainīt ievades izmēru MainActivity.kt failā (koda pašā apakšā konstantes "TARGET_W" un "TARGET_H") uz vainu 500 (priekš 500px apakšmodeļa), vai 720 (priekš 720px apakšmodelā). Aplikācijā izmantotais ONNX modelis un klašu fails (class_names.json) glabāts sekojošā failu direktorijā "\app\src\main\assets".
